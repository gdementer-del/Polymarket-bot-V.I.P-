...
| `4. Исследования` | Локальный backtest, PolyBacktest, sweep параметров и полный wallet-replay workflow |
...
В разделе wallet research доступны наблюдение и запись публичной активности,
сводка, replay timeline, export dataset, симуляция caps/cooldown, сравнение
нескольких экспортов, autotune и калибровка alert thresholds. Если операция
требует несколько JSON-файлов, укажите их через `;`.
